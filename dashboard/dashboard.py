...
with st.sidebar:
    ...
    st.subheader('I Putu Yogi Artha')
    st.caption('Email: yogiartha77@gmail.com')
...
st.subheader('Tren Penjualan (order) Setiap Tahun')
...
def visualize_rfm_df(
    ...
    st.pyplot(fig)
    st.caption('Copyright © I Putu Yogi Artha 2024')
